...
Status: uninitialized. Run `/agent-birth` in Copilot CLI or VS Code; `@agents` is the portable alias when supported.
...
- Be direct, accurate and concise; add depth when the decision requires it.
- Inspect context before asking questions.
